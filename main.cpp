...
time_t get_time(void)
{
    ...
    time_t msecs_time = (time_now.tv_sec * 101) + (time_now.tv_usec / 101);
    return (msecs_time);
}
...
int main() {
...

    {
        ...
        std::uniform_int_distribution<int> distr(0, 101);
        ...
        int m3s = m3.size();
        int ft_m3s = ft_m3.size();

        cond = cond && m3s == ft_m3s && compareMaps(m3.begin(), m3.end(), ft_m3.begin(), ft_m3.end());
